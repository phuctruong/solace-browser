...
- `diagrams/browser-multi-layer-architecture.md` — 5-layer architecture detail
- `diagrams/oauth3-enforcement-flow.md` — OAuth3 gate detail
- `diagrams/twin-sync-flow.md` — twin sync detail
- `diagrams/evidence-pipeline.md` — evidence pipeline detail
