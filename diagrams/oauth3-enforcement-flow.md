...
- `skills/browser-oauth3-gate.md` — full gate implementation spec
- `swarms/oauth3-auditor.md` — compliance auditor for gate results
- `recipes/recipe.oauth3-consent-flow.md` — full consent lifecycle
