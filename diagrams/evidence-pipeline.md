...
- `skills/browser-evidence.md` — full evidence skill specification
- `swarms/evidence-reviewer.md` — evidence review agent
- `recipes/recipe.evidence-review.md` — Part 11 review recipe
- `recipes/recipe.browser-snapshot-audit.md` — snapshot store audit recipe
- `diagrams/part11-alcoa-mapping.md` — detailed ALCOA+ compliance mapping
