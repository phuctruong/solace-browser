...
- `skills/browser-twin-sync.md` — full twin sync skill
- `recipes/recipe.twin-sync.md` — full sync lifecycle recipe
- `combos/twin-delegation.md` — delegation combo using twin sync
- `diagrams/browser-multi-layer-architecture.md` — sync lives between Layer 4 (cloud execution) and Layer 5 (evidence)
