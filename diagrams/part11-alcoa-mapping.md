...
- `skills/browser-evidence.md` — evidence skill with full ALCOA+ implementation
- `swarms/evidence-reviewer.md` — evidence review agent
- `recipes/recipe.evidence-review.md` — Part 11 review recipe
- `recipes/recipe.browser-snapshot-audit.md` — snapshot store audit
- `diagrams/evidence-pipeline.md` — evidence pipeline components
