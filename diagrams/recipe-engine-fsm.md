...
- `skills/browser-recipe-engine.md` — full recipe engine skill
- `swarms/recipe-builder.md` — recipe builder agent
- `swarms/selector-healer.md` — healing for cache-miss scenarios from DOM drift
- `recipes/recipe.recipe-builder.md` — recipe to build new recipes
- `diagrams/browser-multi-layer-architecture.md` — this FSM sits in Layer 3
