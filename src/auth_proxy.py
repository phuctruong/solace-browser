...
Layer 1: Auth Proxy (port 9222) — validates Bearer tokens on every request
...
class AuthProxy:
    ...
    Layer 1: HTTP proxy on port 9222 that validates Bearer tokens.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            proxy_port: Port for the auth proxy to listen on (default 9222).
