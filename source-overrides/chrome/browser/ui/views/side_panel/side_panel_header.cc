...
SidePanelHeader::SidePanelHeader(
  ...
  // SOLACE OVERRIDE: Close button removed — Yinyang sidebar is permanent.
  // The sidebar is always visible as part of the Solace Browser experience.
  // See: source-overrides/README.md
}
