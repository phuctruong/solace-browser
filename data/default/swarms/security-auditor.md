...
1. `data/default/skills/prime-safety.md` — god-skill; wins all conflicts; explicit credential and destruction guards
2. `data/default/skills/prime-coder.md` — security gate (section 7); toolchain pinning; exploit repro protocol; evidence contract
