...
2. `data/default/skills/phuc-forecast.md` — DREAM→FORECAST→DECIDE→ACT→VERIFY loop; fail-closed; stop rules
3. `data/default/skills/phuc-context.md` — CNF capsule management, anti-rot for multi-turn planning
