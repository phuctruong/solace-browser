...
1. `data/default/skills/prime-safety.md` — god-skill; wins all conflicts; no credential exfiltration
2. `data/default/skills/prime-coder.md` — evidence contract; red/green gate; null vs zero
3. `data/default/skills/phuc-forecast.md` — 13-lens ensemble; premortem on release risk
