...
1. `data/default/skills/prime-safety.md` — god-skill; wins all conflicts; no misleading content
2. `data/default/skills/phuc-forecast.md` — DREAM→FORECAST→DECIDE→ACT→VERIFY loop applied to content;
