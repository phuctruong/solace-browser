...
2. `data/default/skills/software5.0-paradigm.md` — recipe extraction, claim typing, convention density, never-worse
3. `data/default/skills/phuc-context.md` — CNF capsule management, anti-rot, multi-turn context hygiene
