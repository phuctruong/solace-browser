...
2. `data/default/skills/prime-wishes.md` — wish contract format, belt progression, gamification, FSM, forbidden states
3. `data/default/skills/prime-mermaid.md` — canonical state graph format for wish state tracking
