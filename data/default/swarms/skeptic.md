...
2. `data/default/skills/prime-coder.md` — evidence contract; verification ladder; replay stability
3. `data/default/skills/phuc-forecast.md` — VERIFY step; falsifiers; adversarial sweep; null edge cases
