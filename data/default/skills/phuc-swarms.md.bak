...
- `data/default/skills/prime-safety.md`  (fail-closed tool safety; “god-skill”)
- `data/default/skills/prime-coder.md`   (deterministic artifacts + evidence discipline)
...
```yaml
mandatory:
  - data/default/skills/prime-safety.md     # god-skill; wins all conflicts
  - data/default/skills/prime-coder.md      # evidence discipline; red-green gate
```
...
```json
{
  ...
  "evidence": [
    {"type": "path", "ref": "data/default/skills/prime-math.md", "sha256": "optional"},
    {"type": "log", "ref": "ls -la data/default/skills/ output"}
  ],
  "verdict": "IN_PROGRESS",
  "rung_target": 641,
  "risk": "medium",
