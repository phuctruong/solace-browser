...
## Modified files
- yinyang_server.py
- tests/test_messaging_apps.py
- data/default/apps/whatsapp-web/manifest.yaml
- data/default/apps/whatsapp-unread/manifest.yaml
- data/default/apps/slack-web/manifest.yaml
- data/default/apps/slack-dm/manifest.yaml
- data/default/apps/discord-web/manifest.yaml
- data/default/apps/discord-notifications/manifest.yaml
- data/default/apps/facebook-messenger/manifest.yaml
- data/default/apps/messenger-unread/manifest.yaml
- data/default/apps/telegram-web/manifest.yaml
- data/default/apps/telegram-unread/manifest.yaml

## Diff
diff --git a/data/default/apps/discord-notifications/manifest.yaml b/data/default/apps/discord-notifications/manifest.yaml
index 8b4edf9f..ddae0400 100644
--- a/data/default/apps/discord-notifications/manifest.yaml
+++ b/data/default/apps/discord-notifications/manifest.yaml
@@ -5,8 +5,18 @@ category: messaging
 status: available
 safety: B
 tier: pro
+tier_reason: "Notification routing and evidence capture require Pro tier"
 site: discord.com
 type: standard
+orchestrates: []
 scopes:
   - discord.read.notifications
   - local.evidence
+partners:
+  produces_for:
+    - morning-brief
...
diff --git a/data/default/apps/discord-web/manifest.yaml b/data/default/apps/discord-web/manifest.yaml
index f8056b7c..85eacdef 100644
--- a/data/default/apps/discord-web/manifest.yaml
+++ b/data/default/apps/discord-web/manifest.yaml
@@ -13,6 +13,9 @@ scopes:
...
+    config: config.yaml
+    defaults: defaults.yaml
diff --git a/data/default/apps/facebook-messenger/manifest.yaml b/data/default/apps/facebook-messenger/manifest.yaml
index 2b2eff61..a8e9c6ba 100644
--- a/data/default/apps/facebook-messenger/manifest.yaml
+++ b/data/default/apps/facebook-messenger/manifest.yaml
@@ -5,8 +5,17 @@ category: messaging
 status: available
 safety: B
 tier: pro
+tier_reason: "Messaging session persistence requires Pro tier"
 site: messenger.com
 type: standard
+orchestrates: []
 scopes:
   - messenger.read.messages
   - local.evidence
+partners:
+  produces_for: []
+  consumes_from: []
...
+    config: config.yaml
+    defaults: defaults.yaml
diff --git a/data/default/apps/messenger-unread/manifest.yaml b/data/default/apps/messenger-unread/manifest.yaml
index 4daa7668..4bfef296 100644
--- a/data/default/apps/messenger-unread/manifest.yaml
+++ b/data/default/apps/messenger-unread/manifest.yaml
@@ -5,8 +5,18 @@ category: messaging
 status: available
 safety: B
 tier: pro
+tier_reason: "Unread monitoring and evidence capture require Pro tier"
 site: messenger.com
 type: standard
+orchestrates: []
 scopes:
   - messenger.read.unread
   - local.evidence
+partners:
+  produces_for:
+    - morning-brief
...
+    config: config.yaml
+    defaults: defaults.yaml
diff --git a/data/default/apps/slack-dm/manifest.yaml b/data/default/apps/slack-dm/manifest.yaml
index 19f4fdf2..9532c096 100644
--- a/data/default/apps/slack-dm/manifest.yaml
+++ b/data/default/apps/slack-dm/manifest.yaml
@@ -5,8 +5,20 @@ category: messaging
 status: available
 safety: B
 tier: pro
+tier_reason: "Direct-message monitoring and routing require Pro tier"
 site: app.slack.com
 type: standard
+orchestrates: []
 scopes:
...
+    config: config.yaml
+    defaults: defaults.yaml
diff --git a/data/default/apps/slack-web/manifest.yaml b/data/default/apps/slack-web/manifest.yaml
index ff97d579..a82c0e4e 100644
--- a/data/default/apps/slack-web/manifest.yaml
+++ b/data/default/apps/slack-web/manifest.yaml
@@ -5,8 +5,17 @@ category: messaging
 status: available
 safety: A
 tier: free
+tier_reason: "Read-only Slack session keep-alive is available on Free tier"
 site: app.slack.com
 type: standard
+orchestrates: []
 scopes:
...
+    config: config.yaml
+    defaults: defaults.yaml
diff --git a/data/default/apps/telegram-unread/manifest.yaml b/data/default/apps/telegram-unread/manifest.yaml
index fb47159e..b6d63451 100644
--- a/data/default/apps/telegram-unread/manifest.yaml
+++ b/data/default/apps/telegram-unread/manifest.yaml
@@ -5,8 +5,19 @@ category: messaging
 status: available
 safety: A
 tier: free
+tier_reason: "Unread badge checks are available on Free tier"
 site: web.telegram.org
 type: standard
+orchestrates: []
 scopes:
   - telegram.read.unread
   - local.evidence
+partners:
+  produces_for:
+    - morning-brief
...
+    config: config.yaml
+    defaults: defaults.yaml
diff --git a/data/default/apps/telegram-web/manifest.yaml b/data/default/apps/telegram-web/manifest.yaml
index 89f24a89..4383622e 100644
--- a/data/default/apps/telegram-web/manifest.yaml
+++ b/data/default/apps/telegram-web/manifest.yaml
@@ -5,8 +5,17 @@ category: messaging
 status: available
 safety: A
 tier: free
+tier_reason: "Read-only Telegram session keep-alive is available on Free tier"
 site: web.telegram.org
 type: standard
+orchestrates: []
 scopes:
...
+    config: config.yaml
+    defaults: defaults.yaml
diff --git a/data/default/apps/whatsapp-unread/manifest.yaml b/data/default/apps/whatsapp-unread/manifest.yaml
index 0c2f11f1..11ff1351 100644
--- a/data/default/apps/whatsapp-unread/manifest.yaml
+++ b/data/default/apps/whatsapp-unread/manifest.yaml
@@ -5,8 +5,19 @@ category: messaging
 status: available
 safety: B
 tier: pro
...
+    config: config.yaml
+    defaults: defaults.yaml
diff --git a/data/default/apps/whatsapp-web/manifest.yaml b/data/default/apps/whatsapp-web/manifest.yaml
index cac85b8b..0795753f 100644
--- a/data/default/apps/whatsapp-web/manifest.yaml
+++ b/data/default/apps/whatsapp-web/manifest.yaml
@@ -5,8 +5,17 @@ category: messaging
 status: available
 safety: B
 tier: pro
...
index b2b0dd0f..fe3baaef 100644
--- a/yinyang_server.py
+++ b/yinyang_server.py
...
+
 def load_evidence(limit: int = 50, offset: int = 0) -> list[dict]:
     ...
     try:
@@ -485,6 +942,320 @@ def load_apps(repo_root: str) -> list[str]:
     return []
...
+
 ...
 # ---------------------------------------------------------------------------
@@ -534,6 +1305,10 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
@@ -624,8 +1399,12 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
@@ -667,6 +1446,8 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
@@ -685,6 +1466,8 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
@@ -715,6 +1498,10 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
@@ -736,6 +1523,11 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
             self._handle_detect()
...
@@ -757,10 +1549,18 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
@@ -813,6 +1613,10 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
@@ -827,6 +1631,10 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
@@ -1789,6 +2597,19 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
+
     def _handle_server_config(self) -> None:
         ...
         self._send_json({
@@ -1818,6 +2639,12 @@ class YinyangHandler(http.server.BaseHTTPRequestHandler):
...
+
     def _handle_vault_status(self) -> None:
         ...
         now = int(time.time())
@@ -2249,6 +3076,73 @@ function choose(mode) {
...
+
     def _handle_session_create(self) -> None:
         if not self._check_auth():
             return
@@ -2266,20 +3160,34 @@ function choose(mode) {
...
+        self._send_json(payload, status)
     ...
     def _handle_session_delete(self, session_id: str) -> None:
         if not self._check_auth():
@@ -2664,10 +3572,13 @@ function choose(mode) {
...
@@ -3374,6 +4285,34 @@ function choose(mode) {
...
+
     def _handle_tunnel_start(self) -> None:
         if not self._check_auth():
             return
@@ -4019,6 +4958,170 @@ function choose(mode) {
...
@@ -4073,6 +5176,7 @@ def build_server(
...
@@ -4095,8 +5199,9 @@ def start_server(
     """
     import os
...
@@ -4107,6 +5212,8 @@ def start_server(
...
diff --git a/tests/test_messaging_apps.py b/tests/test_messaging_apps.py
diff --git a/tests/test_messaging_apps.py b/tests/test_messaging_apps.py
new file mode 100644
index 00000000..9d07df52
--- /dev/null
+++ b/tests/test_messaging_apps.py
@@ -0,0 +1,132 @@
+import json
+import pathlib
+import sys
