...
| File | Purpose | Status |
|------|---------|--------|
| `data/default/recipes/gmail-oauth-login.recipe.json` | OAuth flow | ✅ Production |
| `data/default/recipes/gmail-send-email.recipe.json` | Compose & send | ✅ Production |
...
| `data/default/primewiki/gmail-automation-100.primewiki.md` | This file | ✅ Complete map |
