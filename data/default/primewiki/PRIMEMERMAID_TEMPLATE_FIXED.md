...
1. **Copy this file**: `cp PRIMEMERMAID_TEMPLATE_FIXED.md data/default/primewiki/[domain-page-name].primemermaid.md`
...
4. **Commit to git**:
   ```bash
   git add data/default/primewiki/amazon-gaming-laptop-search.primemermaid.md
...
5. **Reference in recipes**:
   ```json
   {
     ...
     "primewiki_reference": "data/default/primewiki/amazon-gaming-laptop-search.primemermaid.md",
