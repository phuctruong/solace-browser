...
- `data/default/diagrams/recipe-engine-fsm.md` — Layer 3 recipe engine FSM
- `data/default/diagrams/oauth3-enforcement-flow.md` — Layer 3 OAuth3 gate detail
- `data/default/diagrams/evidence-pipeline.md` — Layer 5 evidence pipeline detail
