...
- `data/default/diagrams/browser-multi-layer-architecture.md` — 5-layer view of same pipeline
- `data/default/diagrams/oauth3-enforcement-flow.md` — Phase 2 detail
- `data/default/diagrams/recipe-engine-fsm.md` — Phase 3 FSM detail
- `data/default/diagrams/evidence-pipeline.md` — Phase 5 pipeline detail
- `data/default/diagrams/part11-alcoa-mapping.md` — Phase 5 compliance mapping
