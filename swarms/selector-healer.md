...
1. `skills/prime-safety.md` — god-skill; wins all conflicts; prevents credential leakage through selector values
2. `skills/browser-snapshot.md` — DOM capture, ref-map, bidirectional RoleRefMap, multi-strategy healing chain
