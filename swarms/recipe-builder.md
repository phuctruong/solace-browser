...
1. `skills/prime-safety.md` — god-skill; wins all conflicts; credential and scope guards
2. `skills/browser-recipe-engine.md` — recipe structure, versioning, never-worse gate, CLOSURE enforcement
3. `skills/browser-snapshot.md` — DOM capture, ref-map, selector healing before every action
