...
1. `skills/prime-safety.md` — god-skill; wins all conflicts; prevents evidence fabrication or retroactive modification
2. `skills/browser-evidence.md` — evidence bundle schema; ALCOA+ field map; SHA256 chain protocol; PZip verification; Part 11 compliance requirements
