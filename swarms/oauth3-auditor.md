...
1. `skills/prime-safety.md` — god-skill; wins all conflicts; credential guard; no secrets in outputs
2. `skills/browser-oauth3-gate.md` — 4-gate cascade (G1 token exists → G2 not expired → G3 scope → G4 step-up); audit protocol
3. `skills/browser-evidence.md` — evidence bundle per enforcement event; SHA256 chain; Part 11 fields
